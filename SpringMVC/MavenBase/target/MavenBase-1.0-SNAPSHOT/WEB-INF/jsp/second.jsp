    ...
    <%@include file="header.jsp" %>
        ...
        <div class="container">
            ...
            <div class="panel-body">
                <form:form action="/admin/teacher" method="POST" modelAttribute="teacher" class="form form-horizontal" acceptCharset="UTF-8">
                <div class="form-group">
                    <form:label path="" cssClass="control-label col-sm-3">Name</form:label>
                    <div class="col-sm-9">
                        <form:input path="TName" cssClass="form-control"></form:input>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <form:label path="" cssClass="control-label col-sm-3">Subject</form:label>
                    <div class="col-sm-9">
                    <form:input path="TSubject" cssClass="form-control"></form:input>
                    </div>                        
                </div>
                <div class="form-group">
     ...
     %>
        ...
        <table class="table table-striped">
            <caption><i class="fa fa-lg fa-graduation-cap"></i> Teachers</caption>
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Email</th>
